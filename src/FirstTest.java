...
public class FirstTest {
    ...
    public void setUp() throws Exception
    {
        ...
        capabilities.setCapability("deviceName","andTest");
        capabilities.setCapability("platformVersion","8.0");
        capabilities.setCapability("automationName","Appium");
        capabilities.setCapability("appPackage","org.wikipedia");
        capabilities.setCapability("appActivity",".main.MainActivity");
        capabilities.setCapability("app","/Users/pushmin/Desktop/JavaAppiumAutomation/apks/org.wikipedia.apk");
    ...
    public void testCompareArticleTitle()
    {
        ...
        String article_titile = title_element.getAttribute("text");
    ...
    @Test
    public void testExpectedTextInSearchInput()
    {
        assertElementHasText(
                By.xpath("//*[contains(@text, 'Search Wikipedia')]"),
                "Search Wikipedia",
                "Element doesn't contain the expected text",
                5
        );
    }
    ...
    public void testAmountOfEmptySearch()
    {
        ...
        String search_line = "azxcfdkfvsdv";
        waitForElementAndSendKeys(
                By.xpath("//*[contains(@text, 'Search…')]"),
                search_line,
                "Cannot find search input",
        ...
        waitForElementPresent(
                ...
                "Cannot find empty result label by the reques" + search_line,
                15
        );
    ...
    public void testChangeScreenOrientationOnSearchResult()
    {
        ...
        String title_before_rotation = waitForElementGetAttribute(
                By.id("org.wikipedia:id/view_page_title_text"),
                "text",
        ...
        String title_after_rotation = waitForElementGetAttribute(
                By.id("org.wikipedia:id/view_page_title_text"),
                "text",
                "Cannot find title of article",
                15
        ...
        String title_after_second_rotation = waitForElementGetAttribute(
                By.id("org.wikipedia:id/view_page_title_text"),
                "text",
                "Cannot find title of article",
                15
    ...
    {
        WebElement element = waitForElementPresent(by, error_message, timeoutInSeconds);
        String text_on_element = element.getAttribute("text");
        Assert.assertEquals(
    ...
    private String waitForElementGetAttribute(By by, String attribute, String error_message, long timeoutInSeconds)
    {
        WebElement element = waitForElementPresent(by, error_message, timeoutInSeconds);
